    ...
    public class StudentCollection
    {
        ...
        public Student this[int index]
        {
            ...
            set
            {
                ...
                OnStudentReferenceChanged("Замінено посилання на елемент колекції", value);
            }
        }
        ...
        public bool Remove(int j)
        {
            ...
            students.RemoveAt(j);
            OnStudentCountChanged("Видалено елемент з колекції", student);
            return true;
        }
        ...
        protected virtual void OnStudentCountChanged(string changeInfo, Student student)
        {
            if (StudentCountChanged != null)
            {
                StudentCountChanged(this, new StudentListHandlerEventArgs(CollectionName, changeInfo, student));
            }
        }

        protected virtual void OnStudentReferenceChanged(string changeInfo, Student student)
        {
            if (StudentReferenceChanged != null)
            {
                StudentReferenceChanged(this, new StudentListHandlerEventArgs(CollectionName, changeInfo, student));
            }
        }
    }
}
